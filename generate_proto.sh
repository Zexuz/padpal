...
[ -d "flutter_app/pad_pal/packages/chat_repository/lib/generated" ] && rm -r flutter_app/pad_pal/packages/chat_repository/lib/generated
...
protoc -I ./includes/ -I ./protos/ --go_out=gateway/protos --go-grpc_out=gateway/protos \
  ...
  auth_v1/auth_service.proto chat_v1/chat_service.proto descriptors/rule.proto user_v1/user_service.proto notification_v1/notification_service.proto
