...
class UserRequestedToJoinGame extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UserRequestedToJoinGame', package: const $pb.PackageName('game.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.User>(2, 'user', subBuilder: $1.User.create)
    ..hasRequiredFields = false
  ;
...
class PublicGameInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PublicGameInfo', package: const $pb.PackageName('game.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.User>(7, 'creator', subBuilder: $1.User.create)
    ..pc<$1.User>(8, 'playerRequestedToJoin', $pb.PbFieldType.PM, protoName: 'playerRequestedToJoin', subBuilder: $1.User.create)
    ..pc<$1.User>(9, 'players', $pb.PbFieldType.PM, subBuilder: $1.User.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $1.User get creator => $_getN(6);
  @$pb.TagNumber(7)
  set creator($1.User v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCreator() => $_has(6);
  @$pb.TagNumber(7)
  void clearCreator() => clearField(7);
  @$pb.TagNumber(7)
  $1.User ensureCreator() => $_ensure(6);

  @$pb.TagNumber(8)
  $core.List<$1.User> get playerRequestedToJoin => $_getList(7);

  @$pb.TagNumber(9)
  $core.List<$1.User> get players => $_getList(8);
}
...
class CreateGameRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateGameRequest', package: const $pb.PackageName('game.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.User>(6, 'Creator', protoName: 'Creator', subBuilder: $1.User.create)
  ...
  @$pb.TagNumber(6)
  $1.User get creator => $_getN(5);
  @$pb.TagNumber(6)
  set creator($1.User v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCreator() => $_has(5);
  @$pb.TagNumber(6)
  void clearCreator() => clearField(6);
  @$pb.TagNumber(6)
  $1.User ensureCreator() => $_ensure(5);
